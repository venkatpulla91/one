...
<head>
    ...
    <title>VenkatShop - Modern E-Commerce</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <a href="#" class="logo">Venkat<span>Shop</span></a>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Venkat Collection in 2025</h1>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 VenkatShop. All rights reserved.</p>
            </div>
        </div>
    </footer>
