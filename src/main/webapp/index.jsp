...
<head>
    ...
    <title>VenkatPulla - Modern E-Commerce</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <a href="#" class="logo">YuvaRaj<span>Shop</span></a>
            ...
            <nav id="mainNav">
                <ul>
                    ...
                    <li><a href="#"><i class="fas fa-fire"></i> Trendyvenkat</a></li>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Venkat Devops Engineer v2</h1>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 YuvaRajShop. All rights reserved.</p>
            </div>
        </div>
    </footer>
